...
#define TURBO_FLOW_QUEUE_MODULE "buffer.queue"
#define TURBO_FLOW_QUEUE_DEQUEUE_OPERATION "queue.dequeue"
#define TURBO_FLOW_QUEUE_ENQUEUE_OPERATION "queue.enqueue"
#define TURBO_FLOW_QUEUE_PRIMITIVE_TYPE "QueueBuffer"

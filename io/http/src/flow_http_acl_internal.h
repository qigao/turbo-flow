...
TURBO_FLOW_C_API int flow_http_acl_encode_check_request(const turbo_flow_security_request_t *request,
                                                 char **body_out, size_t *body_size_out);
TURBO_FLOW_C_API int flow_http_acl_decode_check_response(

...
static int flow_mqtt_sn_header(
    const turbo_flow_gateway_frame_view_t *frame, size_t *type_offset,
    uint8_t *type) {
...
static const flow_gateway_plugin_descriptor_t FLOW_MQTT_SN_DESCRIPTOR = {
    "mqtt-sn", TURBO_FLOW_GATEWAY_PROTOCOL_MQTT_SN, "1.2",
...
static const turbo_flow_gateway_plugin_api_t FLOW_MQTT_SN_API = {

# flowstore/backends/redis 模块代码审查

## 概览

| 文件 | 大小 | 职责 |
|---|---|---|
| [flow_redis.c](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c) | 84KB / 1972行 | 核心实现：adapter、stream owner、blob/record store、publisher |
| [flow_redis_config.c](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_config.c) | 31KB / 612行 | YAML 解析 → 各 store 配置校验 |
| [flow_redis_state_store.c](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_state_store.c) | 20KB / 460行 | 状态投影存储（HSET/XPENDING + Lua 原子事务） |
| [flow_redis_index_store.c](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_index_store.c) | 21KB / 530行 | 索引存储（Redis SADD/SMEMBERS + Lua） |
| [flow_redis_log_store.c](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_log_store.c) | 30KB / 629行 | 操作日志存储（Redis Streams + XADD/XREAD） |
| [flow_redis_storage_backend.c](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_storage_backend.c) | 6KB / 156行 | StorageBackend plugin 分发层 |
...
[flow_redis.c:738–740](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L738-L740)
```c
...
[flow_redis.c:753–756](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L753-L756)
```c
...
[flow_redis.c:1005–1073](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L1005-L1073)
...
[flow_redis.c:1240](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L1240)
```c
...
**推论**：调用方可能对 `TURBO_ERANGE` 无处理，直接向上传播为未分类错误。  
...
[flow_redis.c:850–857](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L850-L857)
```c
...
[flow_redis.c:555–568](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L555-L568)
```c
...
[flow_redis_config.c:13–24](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_config.c#L13-L24) vs [flow_redis_config.c:126–137](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_config.c#L126-L137)
...
- `flow_redis_state_reply_u64` ([state_store.c:63](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_state_store.c#L63))
- `flow_redis_log_u64_parse` ([log_store.c:43](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_log_store.c#L43))
- `flow_redis_size_parse` ([index_store.c:47](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis_index_store.c#L47))
...
[flow_redis.c:69](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L69) — `int connected;` (plain int)
...
[flow_redis.c:1367–1368](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L1367-L1368)
```c
...
[flow_redis.c:1688](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L1688)
```c
...
[flow_redis.c:730–731](file:///c:/projects/cpp/turbonet/turbo-flow/flowstore/backends/redis/src/flow_redis.c#L730-L731)
```c

...
if args.rulesforge:
    ...
    children = (
        ...
        "add_dependencies(test_flow_plugin_materializer_generation test_flow_operation_fixture_OK test_flow_plugin_materializer_operation test_flow_plugin_materializer_mismatch test_flow_plugin_materializer_unused)\n"
    )
else:

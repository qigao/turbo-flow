...
#define TURBO_FLOW_RESOLVED_MATERIALIZER_BINDING_VIEW_INIT                                         \
  {sizeof(turbo_flow_resolved_materializer_binding_view_t), NULL, NULL, NULL, NULL, 0u, NULL, 0u}
...
/** Write the materializer binding count; zeroes `count` on error. */
...
/** Borrow one exact materializer binding by index; strings remain config-owned. */

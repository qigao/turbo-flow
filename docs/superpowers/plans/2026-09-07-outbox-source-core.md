...
- [x] **Step 1: Write failing ABI/default/config-validation tests**
...
- [x] **Step 3: Add the public declarations and minimal validation**
...
- [x] **Step 4: Implement default construction and fail-fast open validation**
...
- [x] **Step 5: Run the focused target and verify GREEN**
...
- [x] **Step 1: Write failing zero-demand and minimum-budget tests**
...
- [x] **Step 3: Implement bounded owner state with CSTL Vec slots**
...
- [x] **Step 4: Write failing owned-message and invalid-record tests**
...
- [x] **Step 5: Implement one contiguous retained message buffer**
...
- [x] **Step 1: Write failing success and retryable-failure tests**
...
- [x] **Step 2: Implement per-slot terminal settlement phases**
...
- [x] **Step 3: Write failing permanent failure tests**
...
- [x] **Step 4: Implement permanent-failure sequencing**
...
- [x] **Step 5: Write failing WAIT/data-loss/stop tests**
...
- [x] **Step 6: Implement waitable and bounded stop state machines**
...
- [x] **Step 1: Document state, ownership, error, and migration semantics**
...
- [x] **Step 5: Update GitHub issue evidence and prepare review**

#ifndef FLOWIE_CLUSTER_LIFECYCLE_OWNER_INTERNAL_H
#define FLOWIE_CLUSTER_LIFECYCLE_OWNER_INTERNAL_H
...
#define FLOWIE_CLUSTER_LIFECYCLE_OWNER_ABI_V1 1u

typedef struct flowie_cluster_lifecycle_owner_config_s {
  size_t size;
  ...
  void *now_ctx;
  /** Called when a durable completion cannot safely return to the owner lane. */
  flowie_cluster_session_self_fence_fn self_fence;
  void *self_fence_ctx;
} flowie_cluster_lifecycle_owner_config_t;

#define FLOWIE_CLUSTER_LIFECYCLE_OWNER_CONFIG_INIT                                                 \
  {sizeof(flowie_cluster_lifecycle_owner_config_t),                                                \
   FLOWIE_CLUSTER_LIFECYCLE_OWNER_ABI_V1,                                                          \
   0u,                                                                                             \
   NULL,                                                                                           \
   NULL,                                                                                           \
   NULL,                                                                                           \
...
typedef struct flowie_cluster_lifecycle_owner_s flowie_cluster_lifecycle_owner_t;

typedef struct flowie_cluster_lifecycle_owner_snapshot_s {
  size_t size;
  uint32_t abi_version;
  int last_status;
  ...
  int accepting;
  int active;
} flowie_cluster_lifecycle_owner_snapshot_t;

#define FLOWIE_CLUSTER_LIFECYCLE_OWNER_SNAPSHOT_INIT                                               \
  {sizeof(flowie_cluster_lifecycle_owner_snapshot_t),                                              \
   FLOWIE_CLUSTER_LIFECYCLE_OWNER_ABI_V1,                                                          \
   TURBO_OK,                                                                                       \
   0u,                                                                                             \
   0u,                                                                                             \
...
/** Signature-compatible with flowie_cluster_lifecycle_apply_fn. */
...
#endif /* FLOWIE_CLUSTER_LIFECYCLE_OWNER_INTERNAL_H */
